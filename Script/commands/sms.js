...
module.exports.run = async ({ api, event, args }) => {
  ...
  if (number === "off") {
    if (bombingFlags[threadID]) {
      ...
      return api.sendMessage("✅ SMS বোম্বার বন্ধ করা হয়েছে।Thanks For Use 🅰🅸 🅰🆂🅸🆂🆃🅰🅽🆃 Sms Bomber Tools ✅", threadID);
    } else {
  ...
  api.sendMessage(`✅ SMS বোম্বিং শুরু হয়েছে ${number} নম্বরে...\nবন্ধ করতে /sms off আমি এইটুকু বিশ্বাস রাখতে পারি কেউ খারাপ কাজে অথবা কাউকে বিরক্ত করার জন্য এটি ব্যাবহার করবেন না 🥰`, threadID);
